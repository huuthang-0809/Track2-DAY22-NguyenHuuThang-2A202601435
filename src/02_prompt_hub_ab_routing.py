...
PROMPT_V1_NAME = "nguyen-huu-thang-rag-prompt-v1"
PROMPT_V2_NAME = "nguyen-huu-thang-rag-prompt-v2"


# ── 2. Định nghĩa 2 Prompt Templates ──────────────────────────────────────
SYSTEM_V1 = (
    "Bạn là trợ lý AI thân thiện. Trả lời ngắn gọn 2-4 câu, rõ ràng dựa trên context. "
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích thông tin. Khi trả lời 3-5 câu, hãy: "
...
def ask_ab(retriever, llm, prompt, question: str, version: str) -> dict:
    ...
    Tự động retry nếu gặp lỗi Rate Limit (429).
    """
    for attempt in range(10):
        try:
            ...
            if ("429" in str(e) or "RESOURCE_EXHAUSTED" in str(e)) and attempt < 9:
                print(f" ⏳ Đạt giới hạn Gemini Rate Limit (thử lần {attempt+1}/10), tạm dừng 35s...")
                time.sleep(35)
            else:
                raise e
